  ...
  props: {
    ...
    tableProps: {
      ...
      children: [
        ...
        { label: 'Table 的尺寸', type: 'segmented', value: 'default', key: 'size', options: [{ label: 'large', value: 'large' }, { label: 'default', value: 'default' }, { label: 'small', value: 'small' }] },
        { label: '行和列的布局方式', type: 'segmented', value: '', key: 'tableLayout', options: [{ label: 'fixed', value: 'fixed' }, { label: 'auto', value: 'auto' }] },
        { label: 'height', type: 'input', value: '', key: 'height' }
      ]
    },
    tableColumnProps: {
      title: '表格项',
    ...
    pagingProps: {
      title: '分页',
      children: [
        { label: '每页显示条数', type: 'input', value: '', key: 'pageSize' },
        { label: '当前页', type: 'input', value: '', key: 'currentPage' },
        { label: '总条数', type: 'input' }
      ]
    }
  },
  data: [
